          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid sm:grid-cols-2 md:grid-cols-3 md:grid-rows-10 md:grid-flow-col gap-8">
              ...
              <div className="md:row-start-4 md:row-span-2 h-[350px]">
                <div className="md:row-start-2 md:row-span-2 h-[350px]">
                  <div className="h-full bg-[#D6C8BB] rounded-3xl border-4 border-lightGold hover:border-gold transition hover:scale-[1.02] cursor-pointer shadow-md hover:shadow-xl">
                    <a className="h-full flex flex-col justify-between">
                      <div className="p-10 flex justify-center items-center">
                        <img
              ...
              <div className="md:row-start-6 md:row-span-2 h-[350px]">
                <div className="h-full bg-lightBg rounded-3xl border-4 border-lightGold hover:border-gold transition hover:scale-[1.02] cursor-pointer shadow-md hover:shadow-xl">
                  <a className="h-full flex flex-col justify-between">
                    <div className="p-10 flex justify-center items-center">
                      <img
              ...
              <div className="md:row-end-3 md:row-span-2 h-[350px]">
                <div className="h-full bg-[#F37022] rounded-3xl border-4 border-lightGold hover:border-gold transition hover:scale-[1.02] cursor-pointer shadow-md hover:shadow-xl">
                  <a className="h-full flex flex-col justify-between">
                    <div className="p-10 flex justify-center items-center">
                      <img
              ...
              <div className="md:row-start-3 md:row-span-2 h-[350px]">
                <div className="h-full bg-black rounded-3xl border-4 border-lightGold hover:border-gold transition hover:scale-[1.02] cursor-pointer shadow-md hover:shadow-xl">
                  <a className="h-full flex flex-col justify-between">
                    <div className="p-10 flex justify-center items-center">
                      <svg
                        className="w-full h-full object-cover"
              ...
              <div className="md:row-start-5 md:row-span-2 h-[350px]">
                <div className="h-full bg-[#ece6cc] rounded-3xl border-4 border-lightGold hover:border-gold transition hover:scale-[1.02] cursor-pointer shadow-md hover:shadow-xl">
                  <a className="h-full flex flex-col justify-between">
              ...
              <div className="md:row-start-7 md:row-span-2 h-[350px]">
                <div className="h-full bg-white rounded-3xl border-4 border-lightGold hover:border-gold transition hover:scale-[1.02] cursor-pointer shadow-md hover:shadow-xl">
                  <a className="h-full flex flex-col justify-between">
                    <div className="p-10 flex justify-center items-center">
                      <img
              ...
              {/* LV */}
              <div className="md:row-start-2 md:row-span-2 h-[350px]">
                <div className="h-full bg-[#453630] rounded-3xl border-4 border-lightGold hover:border-gold transition hover:scale-[1.02] cursor-pointer shadow-md hover:shadow-xl">
                  <a className="h-full flex flex-col justify-between">
              ...
              {/* BALENCIAGA */}
              <div className="md:row-start-6 md:row-span-2 h-[350px]">
                <div className="h-full bg-textGray rounded-3xl border-4 border-lightGold hover:border-gold transition hover:scale-[1.02] cursor-pointer shadow-md hover:shadow-xl">
                  <a className="h-full flex flex-col justify-between">
                    <div className="p-10 flex justify-center items-center">
                      <img
